...
export class ServicioService {
  ...
  private uid : string = 'OTa1dKwl41e65EPKA9fM1B22LxI2';
  private carrito : any = [];

  constructor(public data:AngularFireDatabase,@Inject(DOCUMENT) public doc:Document,public alertController:AlertController,public location:Location) { }
